...
[gitea/redirects](https://hub.docker.com/r/gitea/redirects/).

## Install

This websites uses the [Hugo](https://github.com/spf13/hugo) static site
...
* [Contributors](https://github.com/go-gitea/redirects/graphs/contributors)
